...
void ui_screen_openai_screen_init(void)
{
    ...
    lv_obj_set_style_text_font(ui_dalle_title, &lv_font_montserrat_24, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    // Reposition the opaque box to the bottom right
    lv_obj_align(ui_openai_response_box, LV_ALIGN_BOTTOM_RIGHT, -10, -20);
    ...
    lv_obj_set_height(ui_selection_box, 240);
    ...
    lv_obj_set_style_border_color(ui_selection_box, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_align(ui_selection_thumb, LV_ALIGN_BOTTOM_MID, 0, -5);
