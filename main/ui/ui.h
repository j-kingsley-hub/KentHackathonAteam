...
#include "lvgl/lvgl.h"
    ...
    void ui_event_wifi__st_btn_7(lv_event_t *e);
    extern lv_obj_t *ui_time4;
    extern lv_obj_t *ui_wifi__st_btn_7;
    extern lv_obj_t *ui_wifi_st_7;
    extern lv_obj_t *ui_openai_log;
    extern lv_obj_t *ui_openai_response_box;
    void ui_event_chatgpt_btn(lv_event_t *e);
    extern lv_obj_t *ui_chatgpt_btn;
    extern lv_obj_t *ui_chatgpt__title;
    void ui_event_set_api_key_btn(lv_event_t *e);
    extern lv_obj_t *ui_set_api_key_btn;
    extern lv_obj_t *ui_set_api_key_title;
    void ui_event_dalle_btn(lv_event_t *e);
    extern lv_obj_t *ui_dalle_btn;
    extern lv_obj_t *ui_dalle_title;
    // SCREEN: ui_screen_openai_key
    void ui_screen_openai_key_screen_init(void);
    extern lv_obj_t *ui_screen_openai_key;
    extern lv_obj_t *ui_wifi_st_8;
    extern lv_obj_t *ui_set_api_key_title1;
    void ui_event_api_key_back_btn(lv_event_t *e);
    extern lv_obj_t *ui_api_key_back_btn;
    ...
    extern lv_obj_t *ui_chatgpt_1_title;
    extern lv_obj_t *ui_generate_answer_btn;
    extern lv_obj_t *ui_generate_answer_title;
    void ui_event_chatgpt_back_btn(lv_event_t *e);
    extern lv_obj_t *ui_chatgpt_back_btn;
    ...
    extern lv_obj_t *ui_screen_chartgpt_2;
    extern lv_obj_t *ui_regennerate_btn;
    extern lv_obj_t *ui_regennerate_title;
    void ui_event_chatgpt2_back_btn(lv_event_t *e);
    extern lv_obj_t *ui_chatgpt2_back_btn;
    extern lv_obj_t *ui_chatgpt_title;
    ...
    extern lv_obj_t *ui_screen_dalle_1;
    extern lv_obj_t *ui_dalle_back_btn;
    extern lv_obj_t *ui_btn_dall_supriseme;
    extern lv_obj_t *ui_Label5;
    extern lv_obj_t *ui_dalle_title1;
    void ui_event_dalle_text(lv_event_t *e);
    extern lv_obj_t *ui_dalle_text;
    ...
    extern lv_obj_t *ui_screen_dalle_2;
    extern lv_obj_t *ui_btn_dall2_regenerate;
    extern lv_obj_t *ui_btn_dall2_regenerate_title;
    extern lv_obj_t *ui_dalle2_back_btn;
    extern lv_obj_t *ui_Label11;
    extern lv_obj_t *ui_dall_image;
    extern lv_obj_t *ui_wifi_st_12;

    LV_IMG_DECLARE(ui_img_openai_log_png);      // assets/openai_log.png
    LV_IMG_DECLARE(ui_img_set_key_qr_code_png); // assets/set_key_qr_code.png
    LV_IMG_DECLARE(ui_img_sensecap_log_png);    // assets/sensecap_log.png
    LV_IMG_DECLARE(ui_img_chatgpt_log_png);     // assets/chatgpt_log.png
