...
// SCREEN: ui_screen_openai
void ui_screen_openai_screen_init(void);
lv_obj_t *ui_screen_openai;
lv_obj_t *ui_time4;
lv_obj_t *ui_wifi__st_btn_7;
lv_obj_t *ui_wifi_st_7;
lv_obj_t *ui_openai_log;
lv_obj_t *ui_openai_response_box;
lv_obj_t *ui_chatgpt_btn;
lv_obj_t *ui_chatgpt__title;
lv_obj_t *ui_set_api_key_btn;
lv_obj_t *ui_set_api_key_title;
lv_obj_t *ui_dalle_btn;
lv_obj_t *ui_dalle_title;

// SCREEN: ui_screen_openai_key
void ui_screen_openai_key_screen_init(void);
lv_obj_t *ui_screen_openai_key;
lv_obj_t *ui_wifi_st_8;
lv_obj_t *ui_set_api_key_title1;
lv_obj_t *ui_api_key_back_btn;
lv_obj_t *ui_qr_code;

// SCREEN: ui_screen_chartgpt_1
void ui_screen_chartgpt_1_screen_init(void);
lv_obj_t *ui_screen_chartgpt_1;
lv_obj_t *ui_chatgpt_1_title;
lv_obj_t *ui_generate_answer_btn;
lv_obj_t *ui_generate_answer_title;
void ui_event_chatgpt_back_btn(lv_event_t *e);
lv_obj_t *ui_chatgpt_back_btn;
void ui_event_text_edit_gpt_request(lv_event_t *e);
lv_obj_t *ui_text_edit_gpt_request;
lv_obj_t *ui_Panel1;
lv_obj_t *ui_Keyboard_chatgpt;
lv_obj_t *ui_wifi_st_9;

// SCREEN: ui_screen_chartgpt_2
void ui_screen_chartgpt_2_screen_init(void);
lv_obj_t *ui_screen_chartgpt_2;
lv_obj_t *ui_regennerate_btn;
lv_obj_t *ui_regennerate_title;
void ui_event_chatgpt2_back_btn(lv_event_t *e);
lv_obj_t *ui_chatgpt2_back_btn;
lv_obj_t *ui_chatgpt_title;
lv_obj_t *ui_logo_request;
lv_obj_t *ui_text_readonly_gpt_request;
lv_obj_t *ui_text_readonly_gpt_response;
lv_obj_t *ui_logo_response;
lv_obj_t *ui_wifi_st_10;

// SCREEN: ui_screen_dalle_1
void ui_screen_dalle_1_screen_init(void);
lv_obj_t *ui_screen_dalle_1;
lv_obj_t *ui_dalle_back_btn;
lv_obj_t *ui_btn_dall_supriseme;
lv_obj_t *ui_Label5;
lv_obj_t *ui_dalle_title1;
lv_obj_t *ui_dalle_text;
lv_obj_t *ui_Keyboard_dalle;
lv_obj_t *ui_wifi_st_11;

// SCREEN: ui_screen_dalle_2
void ui_screen_dalle_2_screen_init(void);
lv_obj_t *ui_screen_dalle_2;
lv_obj_t *ui_btn_dall2_regenerate;
lv_obj_t *ui_btn_dall2_regenerate_title;
lv_obj_t *ui_dalle2_back_btn;
lv_obj_t *ui_Label11;
lv_obj_t *ui_dall_image;
lv_obj_t *ui_wifi_st_12;
...
void ui_screen_sensor_screen_init(void)
{
      ...
      lv_obj_set_style_bg_color(ui_screen_sensor, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_bg_opa(ui_screen_sensor, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

      extern const lv_img_dsc_t img_bridge;
      extern lv_obj_t *ui_blind_image;
      ui_blind_image = lv_img_create(ui_screen_sensor);
      lv_img_set_src(ui_blind_image, &img_bridge);
      lv_obj_align(ui_blind_image, LV_ALIGN_LEFT_MID, 10, -20);
      lv_obj_move_background(ui_blind_image);

      extern lv_obj_t *ui_blind_response_box;
      ui_blind_response_box = lv_obj_create(ui_screen_sensor);
      lv_obj_set_width(ui_blind_response_box, 240);
      lv_obj_set_height(ui_blind_response_box, 140);
      lv_obj_align(ui_blind_response_box, LV_ALIGN_BOTTOM_RIGHT, -10, -20);
      lv_obj_set_style_bg_color(ui_blind_response_box, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_bg_opa(ui_blind_response_box, 220, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_radius(ui_blind_response_box, 10, 0);

      extern lv_obj_t *ui_blind_label;
      ui_blind_label = lv_label_create(ui_blind_response_box);
      lv_obj_set_width(ui_blind_label, lv_pct(90));
      lv_label_set_long_mode(ui_blind_label, LV_LABEL_LONG_WRAP);
      lv_label_set_text(ui_blind_label, "Press image to analyze the environment.");
      lv_obj_align(ui_blind_label, LV_ALIGN_CENTER, 0, 0);
      lv_obj_set_style_text_color(ui_blind_label, lv_color_hex(0x000000), 0);
      lv_obj_set_style_text_align(ui_blind_label, LV_TEXT_ALIGN_CENTER, 0);

      extern lv_obj_t *ui_blind_selection_box;
      extern lv_obj_t *ui_blind_selection_label;
      ui_blind_selection_box = lv_obj_create(ui_screen_sensor);
      lv_obj_set_width(ui_blind_selection_box, 200);
      lv_obj_set_height(ui_blind_selection_box, 240);
      lv_obj_align(ui_blind_selection_box, LV_ALIGN_TOP_RIGHT, -10, 20);
      lv_obj_set_style_bg_color(ui_blind_selection_box, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_border_width(ui_blind_selection_box, 0, 0);

      extern lv_obj_t *ui_blind_selection_thumb;
      ui_blind_selection_thumb = lv_img_create(ui_blind_selection_box);
      lv_obj_align(ui_blind_selection_thumb, LV_ALIGN_BOTTOM_MID, 0, -5);

      ui_blind_selection_label = lv_label_create(ui_blind_selection_box);
      lv_obj_set_width(ui_blind_selection_label, lv_pct(90));
      lv_label_set_long_mode(ui_blind_selection_label, LV_LABEL_LONG_WRAP);
      lv_label_set_text(ui_blind_selection_label, "Current View:");
      lv_obj_align(ui_blind_selection_label, LV_ALIGN_TOP_MID, 0, 5);
      lv_obj_set_style_text_color(ui_blind_selection_label, lv_color_hex(0x000000), 0);
      lv_obj_set_style_text_align(ui_blind_selection_label, LV_TEXT_ALIGN_CENTER, 0);
...
void ui_screen_setting_screen_init(void)
{
      ...
      lv_obj_set_width(ui_scrolldots3, 200);
      ...
      lv_obj_set_x(ui_scrolldots31, -45);
      lv_obj_set_align(ui_scrolldots31, LV_ALIGN_CENTER);
      ...
      lv_obj_set_x(ui_scrolldots32, -15);
      lv_obj_set_align(ui_scrolldots32, LV_ALIGN_CENTER);
      ...
      lv_obj_set_x(ui_scrolldots33, 15);
      lv_obj_set_align(ui_scrolldots33, LV_ALIGN_CENTER);
      lv_obj_clear_flag(ui_scrolldots33, LV_OBJ_FLAG_SCROLLABLE); /// Flags

      lv_obj_t *ui_scrolldots34 = lv_obj_create(ui_scrolldots3);
      lv_obj_set_width(ui_scrolldots34, 7);
      lv_obj_set_height(ui_scrolldots34, 7);
      lv_obj_set_x(ui_scrolldots34, 45);
      lv_obj_set_align(ui_scrolldots34, LV_ALIGN_CENTER);
      lv_obj_clear_flag(ui_scrolldots34, LV_OBJ_FLAG_SCROLLABLE); /// Flags

      lv_obj_set_style_bg_color(ui_scrolldots34, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_bg_opa(ui_scrolldots34, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_border_color(ui_scrolldots34, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_border_opa(ui_scrolldots34, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
...
void ui_screen_openai_event_init(void)
{
      lv_obj_add_event_cb(ui_wifi__st_btn_7, ui_event_wifi__st_button_7, LV_EVENT_ALL, NULL);
}
