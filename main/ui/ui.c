...
void ui_screen_sensor_screen_init(void)
{
      ...
      lv_obj_set_width(ui_scrolldots2, 200);
      ...
      lv_obj_set_x(ui_scrolldots21, -45);
      lv_obj_set_align(ui_scrolldots21, LV_ALIGN_CENTER);
      ...
      lv_obj_set_x(ui_scrolldots22, -15);
      lv_obj_set_align(ui_scrolldots22, LV_ALIGN_CENTER);
      ...
      lv_obj_set_x(ui_scrolldots23, 15);
      lv_obj_set_align(ui_scrolldots23, LV_ALIGN_CENTER);
      lv_obj_clear_flag(ui_scrolldots23, LV_OBJ_FLAG_SCROLLABLE); /// Flags

      lv_obj_t *ui_scrolldots24 = lv_obj_create(ui_scrolldots2);
      lv_obj_set_width(ui_scrolldots24, 7);
      lv_obj_set_height(ui_scrolldots24, 7);
      lv_obj_set_x(ui_scrolldots24, 45);
      lv_obj_set_align(ui_scrolldots24, LV_ALIGN_CENTER);
      lv_obj_clear_flag(ui_scrolldots24, LV_OBJ_FLAG_SCROLLABLE); /// Flags

      lv_obj_set_style_bg_color(ui_scrolldots22, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_bg_opa(ui_scrolldots22, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_border_color(ui_scrolldots22, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_border_opa(ui_scrolldots22, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
